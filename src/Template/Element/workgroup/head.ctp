...
// 								echo '<li><a href="javascript:console.log(\'notification\');" id="sent-messages" class="fa fa-paper-plane"><span>0</span></a></li>';
								...
								echo '<li>'.$this->Html->link(__('My Forum'), ['controller'=> 'WorkgroupsForums', 'action' => 'index'], ['escape'=>false]).'</li>';
			  	    ...
			  	    <div class="top-bar-center">
			  	      <ul class="dropdown menu" data-dropdown-menu>
			  			...
			  			<li <?php if($this->fetch('title') == 'Projects'){echo 'class="active"'; } ?>>
			  				<?= $this->Html->link(__('<span class="fa fa-tasks"></span> <span>Projects</span>'), ['controller'=> 'WorkgroupProjects', 'action' => 'index'], ['escape'=>false]) ?>
			  			</li>
			  			<li <?php if($this->fetch('title') == 'News'){echo 'class="active"'; } ?>>
			  				<?= $this->Html->link(__('<span class="fa fa-newspaper-o"></span> <span>News</span>'), ['controller'=> 'WorkgroupNews', 'action' => 'index'], ['escape'=>false]) ?>
			  			</li>
			  	        <li <?php if($this->fetch('title') == 'Events'){echo 'class="active"'; } ?>>
			  				<?= $this->Html->link(__('<span class="fa fa-calendar"></span> <span>Events</span>'), ['controller'=> 'WorkgroupEvents', 'action' => 'index'], ['escape'=>false]) ?>
			  			</li>
			  	        <li <?php if($this->fetch('title') == 'Forum'){echo 'class="active"'; } ?>>
			  				<?= $this->Html->link(__('<span class="fa fa-square-o"></span> <span>Forum</span>'), ['controller'=> 'WorkgroupForums', 'action' => 'index'], ['escape'=>false]) ?>
			  			</li>
			  	        <li <?php if($this->fetch('title') == 'Wiki'){echo 'class="active"'; } ?>>
			  				<?= $this->Html->link(__('<span class="fa fa-wikipedia-w"></span> <span>wiki</span>'), ['controller'=> 'WorkgroupWiki', 'action' => 'index'], ['escape'=>false]) ?>
			  			</li>
			  			<li <?php if($this->fetch('title') == 'Media'){echo 'class="active"'; } ?>>
			  				<?= $this->Html->link(__('<span class="fa fa-folder-o"></span> <span>Media</span>'), ['controller'=> 'WorkgroupMedia', 'action' => 'index'], ['escape'=>false]) ?>
			  			</li>
...
<div class="large-12 columns banner-mini">
	<div class="row">
		<?php
			...
			echo '<span class="department-logo" style="background-color: #004A80"></span><h6>'.$workgroup_data->name.'</h6>';
			echo '</div>';
		?>
	</div>
</div>
