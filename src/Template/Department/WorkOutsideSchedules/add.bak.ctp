							...
							<div class="tasks form large-12 medium-12 columns content">
							    ...
							    <fieldset>
							        <?php
							            ...
							            echo '<legend><h5 class="stand-sel"><span>'.$this->Form->radio('stand_option', ['1'=>''], ['label'=>false, 'default'=>true]).'</span><span><label for="stand-option-1">'.__('Stand By / On-Call').'</label></span></h5></legend>';
										...
										echo '</div>';
										echo '<div class="medium-6 columns pad-col-x">';
										echo $this->Form->control('stand_by', ['type' => 'text', 'readonly']);
