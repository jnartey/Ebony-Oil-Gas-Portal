							...
							<div class="tasks form large-12 medium-12 columns content">
							    ...
							    <div class="columns large-12">
							        <?php
							            ...
							            echo $this->Form->control('location', ['type' => 'text', 'id'=>'location']);
										echo '</div>';
										echo '<div class="medium-12 columns pad-col-x">';
										...
										if($workOutsideSchedule->stand_by){
											echo '<legend><h5 class="stand-sel"><span>'.$this->Form->radio('stand_option', ['1'=>''], ['label'=>false, 'checked'=>true]).'</span><span><label for="stand-option-1">'.__('Stand By / On-Call').'</label></span></h5></legend>';
										}else{
											echo '<legend><h5 class="stand-sel"><span>'.$this->Form->radio('stand_option', ['1'=>''], ['label'=>false]).'</span><span><label for="stand-option-1">'.__('Stand By / On-Call').'</label></span></h5></legend>';
										}
										...
										echo '</div>';
										echo '<div class="medium-6 columns pad-col-x">';
										echo $this->Form->control('stand_by', ['type' => 'text', 'readonly', 'required'=>false]);
										...
										echo '<br /><span class="columns"><strong>GHS: </strong></span><span class="columns">'.$this->Form->control('total', ['type' => 'text', 'readonly', 'label'=>false]).'</span>';
										echo '</div>';
										echo '<div class="medium-12 columns pad-col-x">';
