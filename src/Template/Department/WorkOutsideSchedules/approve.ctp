							...
							<div class="tasks form large-12 medium-12 columns content">
							    <div class="columns large-12">
							        <?php
										...
										echo '</div>';
										echo '<div class="medium-4 columns pad-col-x">';
							            echo '<strong>Department:</strong> <span class="label secondary">'.$department_member->department->name.'</span>';
										echo '</div>';
										echo '<div class="medium-4 columns pad-col-x">';
								...
								<div class="columns medium-8">
									<?php
										if(isset($recommended->name)){
											echo 'Recommended by department head or supervisor: <span class="label secondary">'.$recommended->name.'</span>';
											echo '<br />';
										}
									?>
								</div>
								...
								<?php }else{ ?>
									<div class="tasks form large-9 medium-8 columns content float-left">
									    ...
									    <fieldset>
									        <?php
												echo '<div class="medium-12 columns pad-col-x">';
									            echo $this->Form->hidden('department_head', ['value' => $activeUser['id']]);
												echo $this->Form->hidden('department_head_approval_date', ['value' => date('Y-m-d H:i:s')]);
