						...
						<div class="large-12 columns portal-sp">
							...
							<?php
								if($leaveRequest->status == 1){
									...
									if($leaveRequest->recommended_date){
									...
									if($leaveRequest->approved_m_date){
							...
							<?php
								// if($approve->name){
// 									echo 'Recommended by supervisor: <span class="label secondary">'.$approve->name.'</span>';
// 									echo '&nbsp;&nbsp;';
// 								}
