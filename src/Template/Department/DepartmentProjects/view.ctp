					...
					<div class="large-12 columns">
						...
						<div class="large-12 columns">
							...
							<?php
								...
								echo '<a data-fancybox data-type="ajax" href="'.$this->Url->build(DS.'department'.DS.'department-projects'.DS.'upload'.DS.$project->id, true).'" class="button"> <span class="fa fa-upload"></span> Upload file</a>';
							?>
						</div>
						<div class="large-12 columns misc-wrap text-right">
							<?php
								...
								$comment_cat = array(1);
								echo $this->Html->link(__('<span class="fa fa-comments"></span> Comments • '.$this->cell('Misc::countComment', ['DepartmentComments', $comment_cat, $project->id])->render('count')), ['controller' => 'DepartmentProjects', 'action' => 'comments', $project->id], ['class'=>'', 'escape'=>false]);
							?>
						</div>
						...
						<div class="large-12 columns portal-sp">
							<?php
								echo $this->Html->link(__('<span class="fa fa-tasks"></span> Add Task'), ['controller' => 'DepartmentTasks', 'action' => 'add', $project->id], ['class'=>'button active', 'escape'=>false]);
							?>
					        ...
					        <table id="general-table" class="display" width="100%" cellpadding="0" cellspacing="0">
								...
								<tbody>
						            ...
						            <tr>
						                <td><?= h($i) ?></td>
						                <td><?= $this->Html->link($data->name, ['controller' => 'DepartmentTasks', 'action' => 'view', $data->id]); ?></td>
										<?php
											if($project->monitor_timeline == 2){
										...
										<td><?php
												$comment_cat = array(2);
												echo $this->Html->link(__('<span class="fa fa-comments"></span> '.$this->cell('Misc::countComment', ['DepartmentComments', $comment_cat, $data->id, $project->id])->render('count')), ['controller' => 'DepartmentTasks', 'action' => 'view', $data->id], ['class'=>'', 'escape'=>false]);
												echo '&nbsp;&nbsp;';
												echo '<span class="fa fa-folder"></span> '.$this->cell('Misc::countFiles', ['DepartmentMedia', $data->id, $project->id, $data->id, $data->department_id])->render('count');
											 ?></td>
						                <td class="actions">
											<!-- <?= $this->Html->link(__('Assign User(s)'), ['controller' => 'DepartmentProjectMembers', 'action' => 'add', $data->id], ['class'=>'button small']) ?> -->
						                    <?= $this->Html->link(__('View'), ['controller' => 'DepartmentTasks', 'action' => 'view', $data->id], ['class'=>'button small']) ?>
						                    <?php 
												if($activeUser['role_id'] == 1 || $department_details->department_role == 2 || $department_details->department_role == 3){
													echo $this->Html->link(__('Edit'), ['controller' => 'DepartmentTasks', 'action' => 'edit', $data->id], ['class'=>'button small']);
													echo '&nbsp;';
							                    	echo $this->Form->postLink(__('Delete'), ['controller' => 'DepartmentTasks', 'action' => 'delete', $data->id], ['confirm' => __('Are you sure you want to delete # {0}?', $data->name), 'class'=>'button small alert']); 
													echo '&nbsp;';
													if($data->status == 2 || $data->status == 3){
														echo $this->Html->link(__('Review'), ['controller' => 'DepartmentTasks', 'action' => 'review', $data->id], ['class'=>'button small']);
														echo '&nbsp;';
													}
												}
						...
						<div class="large-12 columns portal-sp">
							<?php
								if($activeUser['role_id'] == 1 || $department_details->department_role == 2 || $department_details->department_role == 3){
									echo $this->Html->link(__('<span class="fa fa-plus"></span> Add Project Member(s)'), ['controller' => 'DepartmentProjectMembers', 'action' => 'add', $project->id], ['class'=>'button active', 'escape'=>false]);
								}
					        ...
					        <table id="general-table-i" class="display" width="100%" cellpadding="0" cellspacing="0">
								...
								<tbody>
						            ...
						            <tr>
						                ...
						                <td class="actions">
						                    <!-- <?= $this->Html->link(__('View'), ['controller' => 'DepartmentProjectMembers', 'action' => 'view', $data->id], ['class'=>'button small']) ?> -->
						                    <?php 
												if($activeUser['role_id'] == 1 || $department_details->department_role == 2 || $department_details->department_role == 3){
													echo $this->Form->postLink(__('Remove'), ['controller' => 'DepartmentProjectMembers', 'action' => 'delete', $data->id], ['confirm' => __('Are you sure you want to remove {0}?', $data->user->name), 'class'=>'button small alert']); 
												}
											?>
						                </td>
						            </tr>
