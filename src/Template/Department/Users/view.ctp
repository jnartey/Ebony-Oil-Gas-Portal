		...
		<div class="large-12 columns users">
			...
			<div class="large-12 pad-row">
				<div class="avatar-image">
					<?php 
						if($user->photo){
							...
							$this->Html->image("dummy.png", ["alt" => "Ebony Oil & Gas"]); 
						}
				...
				<div class="avatar-text">
					<!-- <h6>Change Photo</h6> -->
					<?= '<a data-fancybox data-type="ajax" data-src="'.$this->Url->build(DS.'department'.DS.'users'.DS.'upload_photo'.DS.$user->id, true).'" href="javascript:;" class="user-icon"><span><span class="fa fa-pencil"></span></span></a>'; ?>
					<?php 
			...
			<div id="personal-details-edit" class="large-12 pad-row">
				<?php
					if($activeUser['role_id'] == 1 || $department_details->department_role == 2 || $department_details->department_role == 3 || $activeUser['id'] == $user->id){
						echo $this->Form->create($user, ['url' => ['action' => 'personal_details'], 'id'=>'personal-form']);
