				...
				<div class="medium-12 columns portal-box">
					<div class="large-12 columns resources">
						...
						<ul class="resource-links">
							<li><?php echo $this->Html->link(__('News'), ['controller'=> 'DepartmentNews', 'action' => 'index'], ['escape'=>false]); ?></li>
							<li><?php echo $this->Html->link(__('Events'), ['controller'=> 'DepartmentEvents', 'action' => 'index'], ['escape'=>false]); ?></li>
							<li><?php echo $this->Html->link(__('Requests'), ['controller'=> 'requests', 'action' => 'index'], ['escape'=>false]); ?></li>
							<li><?php echo $this->Html->link(__('Company Profile'), ['controller'=> 'pages', 'action' => 'company-profile'], ['escape'=>false]); ?></li>
							<li><?php echo $this->Html->link(__('Document Library'), ['controller'=> 'DepartmentMedia', 'action' => 'index'], ['escape'=>false]); ?></li>
							<li><?php echo $this->Html->link(__('Forum'), ['controller'=> 'departments-forums', 'action' => 'index'], ['escape'=>false]); ?></li>
							  ...
							  <ul class="orbit-container">
								  <?php
								  	...
								  	foreach($events_data as $event):
										...
										echo '<a href="'.$this->Url->build('/department/DepartmentEvents/view/'.$event->id, true).'">';
							  ...
							  <ul class="orbit-container">
								  <?php
								  	...
								  	foreach($news_data as $news):
										...
										echo '<a href="'.$this->Url->build('/department/DepartmentNews/view/'.$news->id, true).'">';	
										if($news->image){
