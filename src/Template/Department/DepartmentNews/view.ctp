						...
						<?php
							...
							if($activeUser['role_id'] == 1 || $department_details->department_role == 2 || $department_details->department_role == 3){
								...
								if($activeUser['id'] == $news->user_id){
									echo $this->Html->link(__('<span class="fa fa-pencil"></span> Edit'), ['controller' => 'DepartmentNews', 'action' => 'edit', $news->id], ['class'=>'button', 'escape'=>false]);
				...
				<div class="large-12 event-content">
					<nav aria-label="You are here:" role="navigation">
					  <ul class="breadcrumbs">
					    <li><?= $this->Html->link(__('News'), ['controller' => 'DepartmentNews', 'action' => 'index'], ['escape'=>false]); ?></li>
					    <li><?= $news->title; ?></li>
					  </ul>
					</nav>
					<?php
