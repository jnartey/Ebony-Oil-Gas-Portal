...
?>
<div id="mains" class="large-12 columns main-content">
	<div class="row">
		<div class="large-12 columns users">
			...
			<div class="large-12 pad-row">
				<div class="avatar-image">
					<?php 
						if($user->photo){
							echo '<div class="profile-photo" style="background-image:url('.$this->Url->build(DS.'files'.DS.'Users'.DS.'photo'.DS.'medium-'.$user->photo).');"></div>';
						}else{
				...
				<div class="avatar-text">
					<!-- <h6>Change Photo</h6> -->
					<?= '<a data-fancybox data-type="ajax" data-src="'.$this->Url->build(DS.'users'.DS.'upload_photo'.DS.$user->id, true).'" href="javascript:;" class="user-icon"><span><span class="fa fa-pencil"></span></span></a>'; ?>
					<?php 
			...
			<div id="personal-details-edit" class="large-12 pad-row">
				<?php
					if($activeUser['role_id'] == 1 || $department_details->department_role == 2 || $department_details->department_role == 3 || $activeUser['id'] == $user->id){
						...
						echo '</div>';
						echo '<div class="medium-6 columns pad-col">';
			            echo $this->Form->control('employee_id', ['type'=>'text']);
						echo '</div>';
						echo '<div class="medium-6 columns pad-col">';
				        echo $this->Form->control('phone_number');
						echo '</div>';
						echo '<div class="medium-12 columns pad-col">';
			...
			<?php if($activeUser['role_id'] == 1 || $activeUser['id'] == $user->id){ ?>
			<hr />
			<div class="large-12 pad-row">
				<div class="medium-12 columns pad-col">
					<h5><?= __('Change Password') ?></h5>
				</div>
				<div id="form-message-i" class="columns large-12"></div>
				<?= $this->Form->create($user, ['url' => ['action' => 'changePassword'], 'id'=>'password-form']) ?> 
				...
				<div class="medium-12 columns pad-col text-right">
					<?php 
						echo $this->Form->button(__('Update password'), ['class'=>'button']);
					?>
				</div>
