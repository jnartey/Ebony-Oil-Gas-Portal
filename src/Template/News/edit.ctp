        ...
        <section class="large-12 columns event-section">
            <div class="large-12 columns event-heading">
                ...
                <div class="column small-9 text-right">
					<?php
						echo $this->Html->link(__('<span class="fa fa-list"></span> All News'), ['controller' => 'news', 'action' => 'index'], ['class'=>'button active', 'escape'=>false]);
						if($activeUser['role_id'] == 1 || $activeUser['role_id'] == 2){
							echo $this->Html->link(__('<span class="fa fa-list"></span> My News'), ['controller' => 'news', 'action' => 'my_news'], ['class'=>'button', 'escape'=>false]);
