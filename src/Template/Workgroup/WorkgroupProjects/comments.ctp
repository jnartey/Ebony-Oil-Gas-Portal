	            ...
	            <div class="large-12 columns event-heading">
	                ...
	                <div class="column small-10 text-right">
						<?php
							...
							echo $this->Html->link(__('<span class="fa fa-tasks"></span> My Tasks'), ['controller' => 'WorkgroupTasks', 'action' => 'index', $activeUser['id']], ['class'=>'button', 'escape'=>false]);
						?>
					</div>
	            </div>
				<div class="large-12 columns event-content">
					...
					<div class="large-12 columns">
						...
						<div id="comments" class="large-12 columns portal-sp comments-box">
							<?php
								$comment_cat = array(1);
								echo '<h6>Comments • '.$this->cell('Misc::countComment', ['WorkgroupComments', $comment_cat, $project->id])->render('count').'</h6>';
								...
								foreach ($posts as $data):
									...
									if($activeUser['role_id'] == 1 || $workgroup_details->user_id == $activeUser['id']){
										...
										echo $this->Html->link(__('Edit'), ['controller' => 'WorkgroupProjects', 'action' => 'comments', $project->id, $data->id], ['class'=>'', 'escape'=>false]);
										echo ' • ';
										echo $this->Form->postLink(
							                __('Delete'),
