						...
						<?php
							...
							if($activeUser['role_id'] == 1 || $workgroup_details->user_id == $activeUser['id']){
								...
								if($activeUser['id'] == $event->user_id){
									echo $this->Html->link(__('<span class="fa fa-pencil"></span> Edit'), ['controller' => 'WorkgroupEvents', 'action' => 'edit', $event->id], ['class'=>'button', 'escape'=>false]);
						...
						<tbody>
				            ...
				            <tr>
				                ...
				                <td class="actions">
				                    ...
				                    <?php 
										if($activeUser['role_id'] == 1 || $workgroup_details->workgroup_role == 2 || $workgroup_details->workgroup_role == 3 || $event->user_id == $activeUser['id']){
