					...
					<?php
						if($check_id){
							if($check_parent_media){
								echo '<a href="'.$this->Url->build(DS.'workgroup'.DS.'workgroup-media'.DS.'index'.DS.$parent_media->parent_id, true).'" class="fa fa-level-up"> <span>Move Up</span></a>';
								echo '<a data-fancybox data-type="ajax" data-src="'.$this->Url->build(DS.'workgroup'.DS.'workgroup-media'.DS.'add_folder'.DS.$parent_media->id, true).'" href="javascript:;" class="fa fa-plus"> <span>New Folder</span></a>';
								echo '<a data-fancybox data-type="ajax" href="'.$this->Url->build(DS.'workgroup'.DS.'workgroup-media'.DS.'add'.DS.$parent_media->id, true).'" class="fa fa-upload"> <span>Upload</span></a>';
							}
						}else{
							echo '<a data-fancybox data-type="ajax" data-src="'.$this->Url->build(DS.'workgroup'.DS.'workgroup-media'.DS.'add_folder', true).'" href="javascript:;" class="fa fa-plus"> <span>New Folder</span></a>';
							echo '<a data-fancybox data-type="ajax" href="'.$this->Url->build(DS.'workgroup'.DS.'workgroup-media'.DS.'add', true).'" class="fa fa-upload"> <span>Upload</span></a>';
						}
					?>
