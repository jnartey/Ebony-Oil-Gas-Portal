	                ...
	                <div class="column small-10 text-right">
						<?php
							...
							if($activeUser['role_id'] == 1 || $workgroup_details->workgroup_role == 2 || $workgroup_details->workgroup_role == 3){
								...
								echo $this->Html->link(__('<span class="fa fa-plus"></span> Edit Task'), ['controller' => 'WorkgroupTasks', 'action' => 'edit', $project->id], ['class'=>'button', 'escape'=>false]);
				...
				<div class="large-12 columns event-content">
					...
					<div class="large-12 columns">
						...
						<div class="large-12 misc-wrap text-right">
							<?php
								echo $this->Html->link(__('<span class="fa fa-folder"></span> Files • 0'), ['controller' => 'WorkgroupMedia', 'action' => 'index', $project->id], ['class'=>'', 'escape'=>false]);
								echo $this->Html->link(__('<span class="fa fa-comments"></span> Comments • '.$this->cell('Misc::count', ['WorkgroupComments', 'comment_src', 2])->render('count')), ['controller' => 'WorkgroupTasks', 'action' => 'view', $task->id, '#'=>'comments'], ['class'=>'', 'escape'=>false]);
							?>
						</div>
							...
							<?php
								foreach ($posts as $data):
									...
									if($activeUser['role_id'] == 1 || $workgroup_details->workgroup_role == 2 || $workgroup_details->workgroup_role == 3 || $activeUser['id'] == $data->user_id){
										...
										echo $this->Html->link(__('Edit'), ['controller' => 'WorkgroupTasks', 'action' => 'review', $task->id, $data->id], ['class'=>'', 'escape'=>false]);
										echo ' • ';
										echo $this->Form->postLink(
							                __('Delete'),
