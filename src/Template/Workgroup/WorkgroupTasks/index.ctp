	        ...
	        <section class="large-12 columns event-section">
	            <div class="large-12 columns event-heading">
	                ...
	                <div class="column small-10 text-right">
						<?php
							echo $this->Html->link(__('Projects'), ['controller' => 'WorkgroupProjects', 'action' => 'index'], ['class'=>'button', 'escape'=>false]);
						?>
					</div>
	            </div>
					        ...
					        <table id="general-table" class="display" width="100%" cellpadding="0" cellspacing="0">
								...
								<tbody>
						            ...
						            <tr>
										...
										<td><?php
											 	echo $this->Html->link(__('<span class="fa fa-comments"></span> '.$this->cell('Misc::count', ['Comments', 'comment_src', 2])->render('count')), ['controller' => 'WorkgroupTasks', 'action' => 'view', $data->project_id], ['class'=>'', 'escape'=>false]); 
												echo '&nbsp;&nbsp;';
												echo $this->Html->link(__('<span class="fa fa-folder"></span> 0'), ['controller' => 'WorkgroupMedia', 'action' => 'index', $data->project_id, $data->id], ['class'=>'', 'escape'=>false]);
											 ?></td>
						                <td class="actions">
						                    ...
						                    <?php 
												if($activeUser['role_id'] == 1 || $activeUser['role_id'] == 2){
													...
													echo '&nbsp;';
													echo $this->Html->link(__('Review'), ['controller' => 'WorkgroupTasks', 'action' => 'review', $data->id, $activeUser['id']], ['class'=>'button small']);
													echo '&nbsp;';
