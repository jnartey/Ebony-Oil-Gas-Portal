...
<div class="departmentsMembers index large-9 medium-8 columns content">
    <h3><?= __('Departments Members') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $departmentsMember->department_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $departmentsMember->department_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $departmentsMember->department_id], ['confirm' => __('Are you sure you want to delete # {0}?', $departmentsMember->department_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
