...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $departmentsForum->department_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $departmentsForum->department_id)]
            )
        ?></li>
...
<div class="departmentsForums form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Departments Forum') ?></legend>
        <?php
