			...
			<div class="large-12 columns event-content">
				...
				<div class="large-12 columns">
				    ...
				    <?php
				    	...
				    	echo $this->Form->control('from_date', ['type' => 'text', 'id'=>'from', 'value'=>date("Y-m-d H:i:s", strtotime($project->from_date))]);
						echo '</div>';
						echo '<div class="medium-6 columns pad-col-x">';
						echo $this->Form->control('to_date', ['type' => 'text', 'id'=>'to', 'value'=>date("Y-m-d H:i:s", strtotime($project->to_date))]);
						echo '</div>';
						echo '<div class="medium-6 columns pad-col-x">';
						echo $this->Form->control('registration_deadline', ['type' => 'text', 'class'=>'extra-date', 'value'=>date("Y-m-d H:i:s", strtotime($project->registration_deadline)]);
						echo '</div>';
