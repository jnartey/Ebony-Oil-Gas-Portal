...
class LeaveDaysTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->requirePresence('annual_leave_days', 'create')
            ->notEmpty('annual_leave_days');

        $validator
            ->integer('study_leave_days')
            ->requirePresence('study_leave_days', 'create')
            ->notEmpty('study_leave_days');

        $validator
            ->integer('maternity_leave_days')
            ->requirePresence('maternity_leave_days', 'create')
            ->notEmpty('maternity_leave_days');

        $validator
            ->integer('paternity_leave_days')
            ->requirePresence('paternity_leave_days', 'create')
            ->notEmpty('paternity_leave_days');
