...
use App\View\Cell\MiscCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\MiscCell Test Case
 */
class MiscCellTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Misc = new MiscCell($this->request, $this->response);
    }
