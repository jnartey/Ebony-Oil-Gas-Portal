...
class HolidaysFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'holiday' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'date' => '2017-10-10 17:38:18',
            'created' => '2017-10-10 17:38:18',
            'modified' => '2017-10-10 17:38:18'
        ],
    ];
}
