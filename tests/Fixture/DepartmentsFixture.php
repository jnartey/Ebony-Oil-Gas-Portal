...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'logo' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => 'The path to the department logo', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-05-18 09:39:01',
            'modified' => '2017-05-18 09:39:01'
        ],
    ];
}
