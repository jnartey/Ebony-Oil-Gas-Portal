...
function updatemembership(){
	...
	foreach ($members_roles as $member => $value) {
		...
		$memberPlugins     	= array_values(array_diff($plugins_core,$disablePlugins));
		$memberModules     	= array_values(array_diff($modules_core,$disableModules));
		$memberExtensions  	= array_values(array_diff($extensions_core,$disableExtensions));
		configeditor(array(
